...
sonido_fondo = pygame.mixer.Sound("/Users/Willy/apuntes-python/PONG/Frutem.mp3")
...
class RaquetaPong:
    def __init__(self):
        ...
        self.imagen = pygame.image.load(os.path.join("/Users/Willy/apuntes-python/PONG", "muro.png")).convert_alpha()
...
def main():
    ...
    pelota = PelotaPong(os.path.join("/Users/Willy/apuntes-python/PONG", "guille.png"))
